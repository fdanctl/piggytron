...
func (s *Service) CreateTransfer(
	...
	fromA := account.Rehydrate(
		...
		fromAccountCID,
		fromAccount.CompletedAt,
		fromAccount.CancelledAt,
		fromAccount.FinalizedAmount,
	...
	toA := account.Rehydrate(
		...
		toAccountCID,
		toAccount.CompletedAt,
		toAccount.CancelledAt,
		toAccount.FinalizedAmount,
		toAccount.Currency,
		toAccount.ClosedAt,
		toAccount.CreatedAt,
		toAccount.UpdatedAt,
...
func (s *Service) UpdateTransfer(
	...
	oldToA := account.Rehydrate(
		...
		oldToAcc.TargetDate,
		oldToAccCID,
		oldToAcc.CompletedAt,
		oldToAcc.CancelledAt,
		oldToAcc.FinalizedAmount,
		oldToAcc.Currency,
		oldToAcc.ClosedAt,
		oldToAcc.CreatedAt,
		oldToAcc.UpdatedAt,
	...
	oldFromA := account.Rehydrate(
		...
		oldFromAccCID,
		oldFromAcc.CompletedAt,
		oldFromAcc.CancelledAt,
		oldFromAcc.FinalizedAmount,
		oldFromAcc.Currency,
		oldFromAcc.ClosedAt,
