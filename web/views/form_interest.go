...
// InterestForm is the view-model for the interest transaction form.
...
func NewInterestForm() *InterestForm {
	f := InterestForm{
...
func (v *InterestForm) ValidateAmount() (msgs []string) {
	if v.Initial {
		return
	}
...
func (v *InterestForm) AmountHasError() bool {
	return len(v.ValidateAmount()) > 0
}

func (v *InterestForm) ValidateCurrency() (msgs []string) {
	if v.Initial {
		return
	}
...
func (v *InterestForm) CurrencyHasError() bool {
	return len(v.ValidateCurrency()) > 0
}

func (v *InterestForm) ValidateDescription() (msgs []string) {
	if v.Initial {
		return
	}
	if v.Description == "" {
...
func (v *InterestForm) DescriptionHasError() bool {
	return len(v.ValidateDescription()) > 0
}

func (v *InterestForm) ValidateDate() (msgs []string) {
	if v.Initial {
		return
	}
...
func (v *InterestForm) DateHasError() bool {
	return len(v.ValidateDate()) > 0
}

func (v *InterestForm) ValidateCategory() (msgs []string) {
	if v.Initial {
		return
	}
...
func (v *InterestForm) CategoryHasError() bool {
	return len(v.ValidateCategory()) > 0
}

func (v *InterestForm) ValidateDestinationAcc() (msgs []string) {
	if v.Initial {
		return
	}
...
func (v *InterestForm) DestinationAccHasError() bool {
